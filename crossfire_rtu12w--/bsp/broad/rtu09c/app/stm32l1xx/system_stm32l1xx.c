...
/** @addtogroup STM32L1xx_System_Private_Functions
  * @{
  */
unsigned long regVtabAddress;
void getRegVtabAddress(unsigned long rx)
{		
		if(rx & 0x000f0000)
			regVtabAddress = 0x08011000;
		else
			regVtabAddress = 0x08002000;
}
/**
...
#else
  SCB->VTOR = regVtabAddress; // FLASH_BASE | VECT_TAB_OFFSET; /* Vector Table Relocation in Internal FLASH. */
#endif
}
